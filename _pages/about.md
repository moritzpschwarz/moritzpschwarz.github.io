...
In my research, I make ample use of econometric time series and panel methods and contribute to the development of open-source estimation software, such as the [gets R-package](https://cran.r-project.org/web/packages/gets/index.html) and the [getspanel R-package](moritzschwarz.org/getspanel). More recently, I have been developing the [aggregate.model](moritzschwarz.org/aggregate.model) R package together with my co-authors.
